...
async function mockRequest(path, options = {}) {
  ...
  if (path.startsWith('/interview/session/') && path.includes('/answer')) {
    const [sessionPart, answerPart] = path.replace('/interview/session/', '').split('/');
    const sessionId = Number(sessionPart);
